...
public class Salad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM salad ORDER BY name ASC", null);
    ...
    public void search_db(View v) {
        ...
        if (!edit_db.equals("")) {
            try {
                cursor = db.rawQuery("SELECT * FROM salad WHERE name LIKE ?",
                        new String[]{"%" + edit_db + "%"});
            ...
            try {
                cursor = db.rawQuery("SELECT * FROM salad ORDER BY name ASC",
                        null);
                adapter = new SimpleCursorAdapter(
                        this,
                        R.layout.isi_lv,
