 ...
 */
public class NonJainStarters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM nonjainstarters ORDER BY name ASC", null);
    ...
    public void search_db(View v) {
        ...
        if (!edit_db.equals("")) {
            try {
                cursor = db.rawQuery("SELECT * FROM nonjainstarters WHERE name LIKE ?",
                        new String[]{"%" + edit_db + "%"});
            ...
            try {
                cursor = db.rawQuery("SELECT * FROM nonjainstarters ORDER BY name ASC",
                        null);
                adapter = new SimpleCursorAdapter(
                        this,
                        R.layout.isi_lv,
